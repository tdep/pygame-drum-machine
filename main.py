...
def draw_load_menu(index):
    ...
    return exit_btn, loading_btn, entry_rectangle, delete_btn, loaded_info
...
while run:
    ...
    if save_menu:
        ...
        exit_button, loading_button, entry_rectangle, delete_button, loaded_info = draw_load_menu(index)
